    ...
    <div className="container mx-auto py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <p className="text-gray-600 dark:text-gray-300">Check system components and services</p>
        </div>
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4">Database Tools</h2>
          <p className="text-gray-600 dark:text-gray-300">Database connection and query testing</p>
        </div>
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4">Authentication</h2>
          <p className="text-gray-600 dark:text-gray-300">Test authentication flows and sessions</p>
        </div>
      </div>
