...
export default function ImageDebugPageClient() {
  ...
  return (
    <div className="container mx-auto py-10">
      <h1 className="text-3xl font-bold mb-6">Image Debug</h1>
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <h2 className="text-xl font-semibold mb-4">Image Testing</h2>
        <p className="text-gray-600 dark:text-gray-300">Test image loading and optimization</p>
      </div>
      {loading ? (
