...
export async function GET(req: NextRequest) {
  try {
    ...
    const pages =
      await sql`SELECT id, title, slug, "metaTitle", "metaDescription", "publishedAt", "_status", "createdAt", "updatedAt" FROM pages ORDER BY "createdAt" DESC`
    ...
    if (format === "html") {
      ...
      return new NextResponse(
        ...
        <head>
          ...
          <title>Pages - Big Based CMS</title>
                    ...
                    <tr>
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                          page._status === "published" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"
                        }">
                          ${page._status || "draft"}
                        </span>
                      </td>
