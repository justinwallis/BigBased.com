...
export default function AdminPage({ params }: { params: { path?: string[] } }) {
  // If no path is provided (just /admin), show the dashboard
  ...
  // If the path is "payload", redirect to the Payload admin
  if (params.path[0] === "payload") {
    redirect("/admin/payload-cms")
  }

  // For any other paths, show a not found message
  return (
    <div className="container mx-auto py-10">
