...
export default async function ArticlePage({ params }: ArticlePageProps) {
  ...
  return (
    <div className="flex bg-white dark:bg-black">
        ...
        <div className="max-w-4xl">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-4">
              ...
              {article.is_featured && (
                <Badge className="bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-500/20">
                  Featured
                </Badge>
              )}
            </div>
            ...
            {article.excerpt && <p className="text-xl text-gray-700 dark:text-gray-300 mb-6">{article.excerpt}</p>}
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Was this helpful?</h3>
      ...
      <aside className="hidden xl:block w-64 p-8 border-l border-gray-200 dark:border-gray-800 bg-white dark:bg-black">
        <div className="sticky top-8">
          ...
          {headings.length > 0 ? (
            ...
            <p className="text-sm text-gray-500 dark:text-gray-500">No headings found</p>
          )}

          {/* Additional Actions */}
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800">
            <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">More resources</h4>
